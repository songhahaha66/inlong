...
# Add current directory to path to import HTTP SDK
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

import inlong_dataproxy_http
...
def main():
    if len(sys.argv) < 2:
        print("USAGE: python http_simple_demo.py config_example.json [inlong_group_id] [inlong_stream_id]")
        return

    inlong_api = inlong_dataproxy_http.InLongApi()
